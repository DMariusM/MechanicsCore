...
import static me.deecaad.core.compatibility.entity.Entity_1_21_R4.getEntityData;
...
public class FakeEntity_1_21_R4 extends FakeEntity {
    ...
    public FakeEntity_1_21_R4(@NotNull Location location, @NotNull EntityType type, @Nullable Object data) {
        super(location, type);
